...
from modules.hear import Hear
from modules.speak import Speak
from core.otak import NeuralNet
from core.NeuralNetwork import tas_kata, tokenize
from modules.wiki import Wiki

try:
    open("utils/PahamiData.pth")
except:
...
with open("utils/memory.json", "r") as json_data:
    memories = json.load(json_data)

FILE = "utils/PahamiData.pth"
